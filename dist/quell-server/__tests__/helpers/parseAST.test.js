...
describe('server tests for parseAST', () => {
    test('should traverse the abstract syntax tree and create a proto object', () => {
      ...
      countries {
        ...
        const parsedQuery = (0, parser_1.parse)(query);
        const { proto, operationType } = (0, quellHelpers_1.parseAST)(parsedQuery);
    ...
    test('should return a proto from a nested query', () => {
      ...
      countries {
        ...
        const { proto, operationType } = (0, quellHelpers_1.parseAST)(AST);
        expect(proto).toEqual({
            countries: {
                __type: 'countries',
                __args: null,
    ...
    fragment CountryInfo on country {
      ...
      population
        ...
        const parsedQuery = (0, parser_1.parse)(query);
        const { proto, operationType, frags } = (0, quellHelpers_1.parseAST)(parsedQuery);
        expect(proto).toEqual({
            Canada: {
                __id: null,
                __type: 'country',
    ...
    test('should not work with directive operation types', () => {
      ...
      country(id: 1, name: "USA") {
        ...
        const parsedQuery = (0, parser_1.parse)(query);
        const { operationType } = (0, quellHelpers_1.parseAST)(parsedQuery);
        expect(operationType).toEqual('unQuellable');
    });
