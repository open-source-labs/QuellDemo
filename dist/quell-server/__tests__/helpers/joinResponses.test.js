...
describe('tests for joinResponses on the server side', () => {
    ...
    test('inputs two flat response objects and outputs combined object', () => {
        ...
        expect((0, quellHelpers_1.joinResponses)(cacheResponse.data, serverResponse.data, proto)).toEqual({
            artist: {
                id: '1',
                name: 'John Coltrane',
                instrument: 'saxophone'
    ...
    test('inputs two nested response objects and outputs combined object', () => {
        ...
        expect((0, quellHelpers_1.joinResponses)(cacheResponse.data, serverResponse.data, prototype)).toEqual({
            artist: {
                id: '1',
                name: 'John Coltrane',
                instrument: 'saxophone',
