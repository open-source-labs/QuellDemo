              ...
              <div className='xl:w-12'></div>
                <div className="flex flex-col ml-6 md:ml-9 md:pt-6 lg:pl-12 lg:ml-12">    
                  <div className="flex flex-col mb-6 xl:w-3/4">
                    ...
                    <button className="bg-transparent border border-lightblue text-lightblue font-sans py-3 px-6 rounded hover:bg-lightblue hover:text-white md:w-1/2 xl:text-xl" onClick={() => { window.location.href = 'https://chrome.google.com/webstore/detail/quell-developer-tool/jnegkegcgpgfomoolnjjkmkippoellod'; } }>Download Now</button>
                  </div>
                </div>
              </div>
            </div>
