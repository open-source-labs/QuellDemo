...
var QuellCache = /** @class */ (function () {
  function QuellCache(_a) {
    var schema = _a.schema,
      _b = _a.cacheExpiration,
      cacheExpiration = _b === void 0 ? 1209600 : _b, // default expiry time is 14 days in milliseconds;
      _c = _a.costParameters, // default expiry time is 14 days in milliseconds;
      costParameters = _c === void 0 ? defaultCostParams : _c,
      redisPort = _a.redisPort,
      redisHost = _a.redisHost,
      redisPassword = _a.redisPassword;
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
            ipRateLimit =
              (_b =
                (_a = req.body.costOptions) === null || _a === void 0
                  ? void 0
                  : _a.ipRate) !== null && _b !== void 0
                ? _b
                : this.costParameters.ipRate;
            ipAddress = req.ip;
            currentTimeSeconds = Math.floor(Date.now() / 1000);
            redisIpTimeKey = ''
              .concat(ipAddress, ':')
              .concat(currentTimeSeconds);
          ...
          case 2:
            redisResponse = _d.sent().map(function (result) {
              return JSON.stringify(result);
            });
            numRequestsString =
              (_c = redisResponse[0]) !== null && _c !== void 0 ? _c : '0';
            ...
            if (numRequests > ipRateLimit) {
              return [
                ...
                next({
                  status: 429,
                  log: 'Redis cache error: Express error handler caught too many requests from this IP address ('
                    .concat(ipAddress, '): limit is: ')
                    .concat(ipRateLimit, ' requests per second'),
                }),
              ];
            }
            console.log(
              'IP '
                .concat(ipAddress, ' made a request. Limit is: ')
                .concat(ipRateLimit, ' requests per second. Result: OK.')
            );
        ...
        switch (_c.label) {
          case 0:
            ...
            if (!req.body.query) {
              return [
                2 /*return*/,
                next({ log: 'Error: no GraphQL query found on request body' }),
              ];
            }
            ...
            (_b =
              (_a = res.locals.parsedAST) !== null && _a !== void 0
                ? _a
                : this.parseAST(AST)),
              (proto = _b.proto),
              (operationType = _b.operationType),
              (frags = _b.frags);
          ...
          case 4:
            ...
            return [
              4 /*yield*/,
              this.buildFromCache(prototype_1, prototypeKeys),
            ];
          case 5:
                    ...
                    return __generator(this, function (_a) {
                      switch (_a.label) {
                        case 0:
                          ...
                          return [
                            4 /*yield*/,
                            this.normalizeForCache(
                              mergedResponse_1.data,
                              this.queryMap,
                              prototype_1,
                              currName
                            ),
                        ...
                        case 1:
                          ...
                          res.locals.queryResponse = __assign(
                            {},
                            mergedResponse_1
                          );
                          return [2 /*return*/, next()];
    ...
    (0, visitor_1.visit)(AST, {
      ...
      enter: function (node) {
        ...
        if (node === null || node === void 0 ? void 0 : node.directives) {
          if (
            (_b =
              (_a =
                node === null || node === void 0 ? void 0 : node.directives) ===
                null || _a === void 0
                ? void 0
      ...
      Field: {
        ...
        enter: function (node) {
          ...
          var fieldType = node.alias ? node.alias.value : node.name.value;
      ...
      SelectionSet: {
        ...
        enter: function (
          ...
          if (
            ...
            var fieldsObject_1 = __assign(
              __assign({}, fieldsValues),
  ...
  QuellCache.prototype.getFieldsMap = function (schema) {
    ...
    var customTypes = Object.keys(typesList).filter(function (type) {
      var _a;
      return (
    ...
    // loop through types
    for (
      var _i = 0, customTypes_1 = customTypes;
      _i < customTypes_1.length;
      _i++
    ) {
   ...
   */
  QuellCache.prototype.buildFromCache = function (
    prototype,
    prototypeKeys,
    itemFromCache,
    firstRun,
              ...
              return __generator(this, function (_l) {
                switch (_l.label) {
                  case 0:
                    ...
                    if (
                      ((_a = prototype[typeKey]) === null || _a === void 0
                        ? void 0
                        : _a.__args) === null
                    ) {
                      keyName = undefined;
                      ...
                      keyName = Object.values(
                        (_b = prototype[typeKey]) === null || _b === void 0
                          ? void 0
                          : _b.__args
                      )[0];
                    }
                  ...
                  case 1:
                    ...
                    itemFromCache[typeKey] = cacheResponse
                  ...
                  case 2:
                      ...
                      return __generator(this, function (_m) {
                        switch (_m.label) {
                          case 0:
                                  ...
                                  // if prototype is nested at this field, recurse
                                    ...
                                    _this
                                      .buildFromCache(
                                        ...
                                        false,
                                        ''
                                          .concat(currTypeKey_1, '--')
                                          .concat(property)
                                      )
                                      .then(function (tempData) {
                                        return (tempObj[property] =
                                          tempData.data);
                                      });
                                  }
                            ...
                            if (
                              !(i !== 0 && i % this_1.redisReadBatchSize === 0)
                            )
                              return [3 /*break*/, 5];
                            _m.label = 1;
                          case 1:
                          ...
                          case 3:
                            err_2 = _m.sent();
                            console.log(
                              'Error in buildFromCache: '.concat(err_2)
                            );
                            return [3 /*break*/, 4];
                          case 4:
                            redisRunQueue = this_1.redisCache.multi();
                          ...
                          case 8:
                            err_3 = _m.sent();
                            console.log(
                              'Error in buildFromCache: '.concat(err_3)
                            );
                            return [3 /*break*/, 9];
                          case 9:
                            return [2 /*return*/];
                    ...
                    _l.label = 3;
                  case 3:
                    if (!(i < itemFromCache[typeKey].length))
                      return [3 /*break*/, 6];
  ...
  QuellCache.prototype.createQueryStr = function (queryObject, operationType) {
    ...
    for (var key in queryObject) {
      mainStr += ' '
        .concat(key)
        .concat(getAliasType(queryObject[key]))
        .concat(getArgs(queryObject[key]), ' ')
        .concat(openCurly, ' ')
        .concat(stringify(queryObject[key]))
        .concat(closeCurly);
    }
    /**
    ...
    function getArgs(fields) {
      ...
      return argString
        ? ''.concat(openParen).concat(argString).concat(closeParen)
        : '';
    }
   ...
   */
  QuellCache.prototype.joinResponses = function (
    cacheResponse,
    serverResponse,
    queryProto,
    fromArray
    ...
    for (var key in queryProto) {
      ...
      var checkResponse = Object.prototype.hasOwnProperty.call(
        serverResponse,
        key
      )
        ? serverResponse
      ...
      if (Array.isArray(checkResponse[key])) {
        ...
        if (cacheResponse[key] && serverResponse[key]) {
          ...
          if (keysSame) {
            mergedResponse[key] = __spreadArray(
              __spreadArray([], cacheResponse[key], true),
              serverResponse[key],
              true
            );
          }
          // otherwise, we need to combine the responses at the object level
            ...
            for (var i = 0; i < cacheResponse[key].length; i++) {
              ...
              var joinedResponse = this.joinResponses(
                ((_a = {}), (_a[key] = cacheResponse[key][i]), _a),
                ((_b = {}), (_b[key] = serverResponse[key][i]), _b),
                ((_c = {}), (_c[key] = queryProto[key]), _c),
                true
              );
          ...
          if (
            ...
            if (
              ...
              mergedRecursion = this.joinResponses(
                ...
                _e),
                ((_f = {}), (_f[fieldName] = queryProto[key][fieldName]), _f)
              );
   ...
   */
  QuellCache.prototype.updateCacheByMutation = function (
    dbRespDataRaw,
    mutationName,
    mutationType,
    mutationQueryObject
        ...
        switch (_b.label) {
          case 0:
            ...
            if (dbRespDataRaw.data) {
              ...
              dbRespId =
                (_a = dbRespDataRaw.data[mutationName]) === null ||
                _a === void 0
                  ? void 0
                  : _a.id;
              dbRespData = JSON.parse(
            ...
            for (queryKey in this.queryMap) {
              ...
              if (
                JSON.stringify(queryKeyType) === JSON.stringify([mutationType])
              ) {
                fieldsListKey = queryKey;
                break;
              }
            }
            removeFromFieldKeysList = function (fieldKeysToRemove) {
              return __awaiter(_this, void 0, void 0, function () {
                  ...
                  switch (_a.label) {
                    ...
                    case 1:
                      ...
                      if (
                        ...
                        cachedFieldKeysList_1 = JSON.parse(
                        ...
                        fieldKeysToRemove.forEach(function (fieldKey) {
                          ...
                          var removalFieldKeyIdx =
                            cachedFieldKeysList_1.indexOf(fieldKey);
            ...
            deleteApprFieldKeys = function () {
              return __awaiter(_this, void 0, void 0, function () {
                var cachedFieldKeysListRaw,
                  cachedFieldKeysList,
                  fieldKeysToRemove,
                  i,
                  fieldKey,
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    ...
                    case 1:
                      ...
                      _a.label = 2;
                    case 2:
                      if (!(i < cachedFieldKeysList.length))
                        return [3 /*break*/, 5];
                      fieldKey = cachedFieldKeysList[i];
                      return [
                        4 /*yield*/,
                        this.getFromRedis(fieldKey.toLowerCase()),
                      ];
                    case 3:
                      fieldKeyValueRaw = _a.sent();
                      if (
                        fieldKeyValueRaw !== null &&
                        fieldKeyValueRaw !== undefined
                      ) {
                  ...
                  switch (_a.label) {
                    ...
                    case 1:
                      ...
                      if (cachedFieldKeysListRaw !== null) {
                        cachedFieldKeysList = JSON.parse(
                          cachedFieldKeysListRaw
                        );
                        ...
                        cachedFieldKeysList.forEach(function (fieldKey) {
                          return __awaiter(_this, void 0, void 0, function () {
                            var fieldKeyValueRaw,
                              fieldKeyValue_1,
                              fieldsToUpdateBy_1,
                              updatedFieldKeyValue_1;
                            return __generator(this, function (_a) {
                              switch (_a.label) {
                                case 0:
                                  return [
                                ...
                                case 1:
                                  ...
                                  if (
                                    ...
                                    Object.entries(
                                      mutationQueryObject.__args
                                    ).forEach(function (_a) {
                                      var arg = _a[0],
                                        argVal = _a[1];
                                      if (
                                        arg in fieldKeyValue_1 &&
                                        fieldKeyValue_1[arg] === argVal
                                      ) {
                                        // foreign keys are not fields to update by
                                        if (
                                          arg.toLowerCase().includes('id') ===
                                          false
                                        ) {
                                          // arg.toLowerCase
            ...
            hypotheticalRedisKey = ''
              .concat(mutationType.toLowerCase(), '--')
              .concat(dbRespId);
              ...
              if (mutationQueryObject.__id) {
                if (mutationName.substring(0, 3) === 'del') {
                  ...
                  this.deleteCacheById(
                    ''
                      .concat(mutationType.toLowerCase(), '--')
                      .concat(mutationQueryObject.__id)
                  );
                  removeFromFieldKeysList([
                    ''.concat(mutationType, '--').concat(dbRespId),
                  ]);
                } else {
   ...
   */
  QuellCache.prototype.normalizeForCache = function (
    responseData,
    map,
    protoField,
    currName
        ...
        switch (_m.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.normalizeForCache(
                ((_h = {}), (_h[dataType] = el), _h),
                map,
                ((_j = {}), (_j[dataType] = currProto), _j),
                currName
              ),
            ];
          case 3:
          ...
          case 6:
            ...
            fieldStore = {};
            cacheID = Object.prototype.hasOwnProperty.call(
              map,
              currProto.__type
            )
          ...
          case 7:
            ...
            return [
              4 /*yield*/,
              this.normalizeForCache(
                ((_k = {}), (_k[key] = currField[key]), _k),
                map,
                ((_l = {}), (_l[key] = protoField[resultName][key]), _l),
                currName
              ),
            ];
          case 8:
  ...
  QuellCache.prototype.getRedisInfo = function (options) {
    ...
    var getOptions = function (opts) {
      var getStats = opts.getStats,
        getKeys = opts.getKeys,
            ...
            var output = {
              ...
              server: [
                // redis version
                {
                  name: 'Redis version',
                  value:
                    (_a = dataLines.find(function (line) {
                      return line.match(/redis_version/);
                    })) === null || _a === void 0
                      ? void 0
                      : _a.split(':')[1],
                },
                // redis build id
                {
                  name: 'Redis build id',
                  value:
                    (_b = dataLines.find(function (line) {
                      return line.match(/redis_build_id/);
                    })) === null || _b === void 0
                      ? void 0
                      : _b.split(':')[1],
                },
                // redis mode
                {
                  name: 'Redis mode',
                  value:
                    (_c = dataLines.find(function (line) {
                      return line.match(/redis_mode/);
                    })) === null || _c === void 0
                      ? void 0
                      : _c.split(':')[1],
                },
                // os hosting redis system
                {
                  ...
                  value:
                    (_d = dataLines.find(function (line) {
                      return line.match(/os/);
                    })) === null || _d === void 0
                      ? void 0
                      : _d.split(':')[1],
                },
                // TCP/IP listen port
                {
                  name: 'TCP/IP port',
                  value:
                    (_e = dataLines.find(function (line) {
                      return line.match(/tcp_port/);
                    })) === null || _e === void 0
                      ? void 0
                      : _e.split(':')[1],
                },
                ...
                // num of seconds since Redis server start
                {
                  ...
                  value:
                    (_f = dataLines.find(function (line) {
                      return line.match(/uptime_in_seconds/);
                    })) === null || _f === void 0
                      ? void 0
                      : _f.split(':')[1],
                },
                // num of days since Redis server start
                {
                  ...
                  value:
                    (_g = dataLines.find(function (line) {
                      return line.match(/uptime_in_days/);
                    })) === null || _g === void 0
                      ? void 0
                      : _g.split(':')[1],
                },
                ...
                // path to server's configuration file
                {
                  ...
                  value:
                    (_h = dataLines.find(function (line) {
                      return line.match(/config_file/);
                    })) === null || _h === void 0
                      ? void 0
                      : _h.split(':')[1],
                },
              ...
              client: [
                // number of connected clients
                {
                  ...
                  value:
                    (_j = dataLines.find(function (line) {
                      return line.match(/connected_clients/);
                    })) === null || _j === void 0
                      ? void 0
                      : _j.split(':')[1],
                },
                // number of sockets used by cluster bus
                {
                  ...
                  value:
                    (_k = dataLines.find(function (line) {
                      return line.match(/cluster_connections/);
                    })) === null || _k === void 0
                      ? void 0
                      : _k.split(':')[1],
                },
                // max clients
                {
                  name: 'Max clients',
                  value:
                    (_l = dataLines.find(function (line) {
                      return line.match(/maxclients/);
                    })) === null || _l === void 0
                      ? void 0
                      : _l.split(':')[1],
                },
                ...
                // blocked clients
                {
                  ...
                  value:
                    (_m = dataLines.find(function (line) {
                      return line.match(/blocked_clients/);
                    })) === null || _m === void 0
                      ? void 0
                      : _m.split(':')[1],
                },
              ...
              memory: [
                // total allocated memory
                {
                  ...
                  value:
                    (_o = dataLines.find(function (line) {
                      return line.match(/used_memory_human/);
                    })) === null || _o === void 0
                      ? void 0
                      : _o.split(':')[1],
                },
                // peak memory consumed
                {
                  ...
                  value:
                    (_p = dataLines.find(function (line) {
                      return line.match(/used_memory_peak_human/);
                    })) === null || _p === void 0
                      ? void 0
                      : _p.split(':')[1],
                },
              ...
              stats: [
                // total number of connections accepted by server
                {
                  ...
                  value:
                    (_q = dataLines.find(function (line) {
                      return line.match(/total_connections_received/);
                    })) === null || _q === void 0
                      ? void 0
                      : _q.split(':')[1],
                },
                // total number of commands processed by server
                {
                  name: 'Total commands',
                  value:
                    (_r = dataLines.find(function (line) {
                      return line.match(/total_commands_processed/);
                    })) === null || _r === void 0
                      ? void 0
                      : _r.split(':')[1],
                },
                // number of commands processed per second
                {
                  ...
                  value:
                    (_s = dataLines.find(function (line) {
                      return line.match(/instantaneous_ops_per_sec/);
                    })) === null || _s === void 0
                      ? void 0
                      : _s.split(':')[1],
                },
                ...
                // total number of error replies
                {
                  name: 'Error replies',
                  value:
                    (_t = dataLines.find(function (line) {
                      return line.match(/total_error_replies/);
                    })) === null || _t === void 0
                      ? void 0
                      : _t.split(':')[1],
                },
                // total number of bytes read from network
                {
                  ...
                  value:
                    (_u = dataLines.find(function (line) {
                      return line.match(/total_net_input_bytes/);
                    })) === null || _u === void 0
                      ? void 0
                      : _u.split(':')[1],
                },
                // networks read rate per second
                {
                  ...
                  value:
                    (_v = dataLines.find(function (line) {
                      return line.match(/instantaneous_input_kbps/);
                    })) === null || _v === void 0
                      ? void 0
                      : _v.split(':')[1],
                },
                ...
                // networks write rate per second
                {
                  ...
                  value:
                    (_w = dataLines.find(function (line) {
                      return line.match(/instantaneous_output_kbps/);
                    })) === null || _w === void 0
                      ? void 0
                      : _w.split(':')[1],
                },
  ...
  QuellCache.prototype.depthLimit = function (req, res, next) {
    ...
    var determineDepth = function (proto, currentDepth) {
      ...
      if (currentDepth > maxDepth) {
        var err = {
          log: 'Depth limit exceeded, tried to send query with the depth of '.concat(
            currentDepth,
            '.'
          ),
          status: 413,
  ...
  QuellCache.prototype.costLimit = function (req, res, next) {
    ...
    var _a = this.costParameters,
      mutationCost = _a.mutationCost,
      objectCost = _a.objectCost,
      depthCostFactor = _a.depthCostFactor,
      scalarCost = _a.scalarCost;
    ...
    var determineCost = function (proto) {
      ...
      if (cost > maxCost) {
        var err = {
          log: 'Cost limit exceeded, tried to send query with a cost exceeding '.concat(
            maxCost,
            '.'
          ),
          status: 413,
